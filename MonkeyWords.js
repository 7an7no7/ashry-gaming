...
const MONKEY_LISTS = {
  ar: {
    ...
    "آيسلندا", "الهند", "إندونيسيا", "إيران", "العراق", "أيرلندا", "إيطاليا", "جامايكا", "اليابان",
  ...
  en: {
    ...
    "Mexico City", "Rio de Janeiro", "Sao Paulo", "Buenos Aires", "Hong Kong", "Kuala Lumpur", "Abu Dhabi", "Cape Town", "Sharm El Sheikh",
