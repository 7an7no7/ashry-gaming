...
const EXPORTS = ['ROOM_GAME_IDS', 'applyRoomAction', 'roomDeadline', 'roomTimeout', 'withPromptMemory', 'normaliseClue', 'foldStopAnswer', 'stopAnswerFits', 'stopWordKnown', 'stopDictionary', 'roomEvent', 'chatFor'];
