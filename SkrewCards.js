...
const SKREW_CARDS = {
  ...
  s9:     { group: 'base', count: 4, value: 9,  kind: 'command', power: 'spyOther', icon: '🔍', ar: 'شوف كارت حد', en: 'Spy' },
  s10:    { group: 'base', count: 4, value: 10, kind: 'command', power: 'spyOther', icon: '🔍', ar: 'شوف كارت حد', en: 'Spy' },
